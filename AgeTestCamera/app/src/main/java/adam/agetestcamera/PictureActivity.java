...
import filter.BitmapFilter;
import progress.FoldingCirclesDrawable;
...
//		skintext.setTextColor(palette.getLightVibrantColor(Color.RED));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.SHARE_IT).setIcon(new IconDrawable(this, Iconify.IconValue.fa_send).colorRes(R.color.female).actionBarSize());
        menu.findItem(R.id.GRAY_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_align_center).colorRes(R.color.material_grey).actionBarSize());
        menu.findItem(R.id.BLOCK_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_pagelines).colorRes(R.color.material_green).actionBarSize());
        menu.findItem(R.id.OLD_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_heart_o).colorRes(R.color.material_red).actionBarSize());
        menu.findItem(R.id.CARTON_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_reddit_square).colorRes(R.color.material_pink).actionBarSize());
        menu.findItem(R.id.MOLTEN_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_shield).colorRes(R.color.material_purple).actionBarSize());
        menu.findItem(R.id.SOFTNESS_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_umbrella).colorRes(R.color.material_deeppurple).actionBarSize());
        menu.findItem(R.id.ECLOSION_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_tachometer).colorRes(R.color.material_indigo).actionBarSize());
        menu.findItem(R.id.RELIEF_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_yelp).colorRes(R.color.material_cyan).actionBarSize());
        menu.findItem(R.id.OIL_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_flag_checkered).colorRes(R.color.material_teal).actionBarSize());
        menu.findItem(R.id.INVERT_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_eye).colorRes(R.color.material_lime).actionBarSize());
        menu.findItem(R.id.LIGHT_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_sun_o).colorRes(R.color.material_yellow).actionBarSize());
        menu.findItem(R.id.LOMO_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_pied_piper_alt).colorRes(R.color.material_orange).actionBarSize());
        menu.findItem(R.id.HAHA_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_tree).colorRes(R.color.material_amber).actionBarSize());
        menu.findItem(R.id.ICE_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_frown_o).colorRes(R.color.material_ice).actionBarSize());
        menu.findItem(R.id.NO_STYLE).setIcon(new IconDrawable(this, Iconify.IconValue.fa_smile_o).colorRes(R.color.material_w).actionBarSize());
        return true;
    }
    /**
     * 所有滤镜效果的id
